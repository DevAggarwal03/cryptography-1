...
const DDES_1 = require("./SymmetricKey/DES/doubleDataEcyrptionStandard/DDES");
...
console.log("message: ", tempPara);
const DDesCipher = (0, DDES_1.DDESEncryption)(tempPara, "SECRE1", "SECRE2");
console.log("cipher hex: ", DDesCipher);
const DDesPlainText = (0, DDES_1.DDESDescryption)(DDesCipher, "SECRE1", "SECRE2");
