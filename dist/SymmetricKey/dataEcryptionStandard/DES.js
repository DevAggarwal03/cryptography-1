...
// import { unpadPKCS7 } from "./helperFunctions";
// main des encryption function
const DESEncryption = (plainTxt, key) => {
    // xxxxxxxx xxxxxxxx ...
    const binaryPlainTxt = (0, conversions_1.toBinary)(plainTxt);
    console.log("b plain txt: ", binaryPlainTxt);
    const binaryKeyStr = (0, conversions_1.toBinary)(key);
    const arr64Plain = (0, conversions_1.make64BitArr)(binaryPlainTxt);
    const arr64Key = (0, conversions_1.make64BitArr)(binaryKeyStr);
...
const DESDescryption = (cipherHex, key) => {
    const binaryKeyStr = (0, conversions_1.toBinary)(key);
    const cipherTxt = (0, conversions_1.hexTo64BitBinaryArray)(cipherHex);
    ...
    const binaryPlainTxt = (0, conversions_1.arr64bitToBinStr)(arr64Plain);
    const plainTxt = (0, conversions_1.toTxt)(binaryPlainTxt);
    return plainTxt;
};
